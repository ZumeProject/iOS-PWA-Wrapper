...
let appTitle = "Zúme Training"
let webAppUrl = URL(string: "https://app.zume.training")
let allowedOrigin = "app.zume.training"
...
let navigationBarColor = getColorFromHex(hex: 0x21336a, alpha: 1.0)
